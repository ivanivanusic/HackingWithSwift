...
let rendered = renderer.image { ctx in
    ...
    let circle1 = CGRect(x: 300, y: 400, width: 200, height: 200)
    ctx.cgContext.addEllipse(in: circle1)
    ctx.cgContext.drawPath(using: .fillStroke)
    
    let circle2 = CGRect(x: 500, y: 400, width: 200, height: 200)
    ctx.cgContext.addEllipse(in: circle2)
    ctx.cgContext.drawPath(using: .fillStroke)
    
    let circle3 = CGRect(x: 400, y: 300, width: 200, height: 200)
    ctx.cgContext.addEllipse(in: circle3)
    ctx.cgContext.drawPath(using: .fillStroke)
    
    let circle4 = CGRect(x: 400, y: 500, width: 200, height: 200)
